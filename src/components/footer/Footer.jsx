...
const Footer = () => {
  return (
    <footer className="text-white py-4 mt-auto bg-[#FF7700]"> {/* mt-auto asegura que el footer se quede abajo */}
      <div className="container mx-auto flex justify-center space-x-8"> {/* Espaciado ajustado */}
